...
do
{
    ...
    cout << "1. Game information" << endl;
    cout << "2. Start Multiplayer" << endl;
    cout << "3. Exit" << endl;
    switch (choice)
    {
    case 1:
        cout << "Game of battleship, place out your five ships using the coordinate system A-0, 1-15 and the direction you want to place your ship E or S" << endl;
        break;
    case 2:
    cout << "Write your names" << endl;
    getline(cin,player1);
    getline(cin,player2);
    break;
    case 3:
